...
setwd("/scratch/Shares/rinnclass/CLASS_2023/emal2471/CLASS_2023/CLASSES/05_R_analyses/class_exercise/")
...
```{R loading gencode, lncRNA, mRNA, and TF annotation files } 
...
# Read in DBP annotations as TF, then merge TF annotation file to num_peaks_df
...
# ...Then use count_peaks_per_feature function to find overlaps
...
# It is nice and all to find overlaps, but I am interested in how many proteins bind a specific promoter. I will use my handy "occurence" parameter in count_peaks_per_feature 
